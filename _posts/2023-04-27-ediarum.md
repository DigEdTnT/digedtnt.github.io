...
* Sobald wir anschließend im Text auf eine Zutat stoßen, klicken wir auf den Zutaten-Button und wählen aus der Registeransicht, den entsprechenden Eintrag. 
  {% include image.html url="../data/pipelines/pipeline_1/ediarum/img/ingredients-annotation.PNG" description="Annotation der Zutaten mit projektspezifischem Button" %}
...
* Über den Punkt **Sachregister** in der untersten Menüleiste ist es uns außerdem möglich, eine **Alternative Bezeichnung** anzulegen (oder sogar Unterlisten zu erstellen).  
...
* Zuletzt möchten wir für unseren Eintrag noch die automatisch generierte `@xml:id` ändern. Dafür gehen wir auf unseren Eintrag und wählen  nach einem Rechtsmausklick im daraufhin erscheinenden Menü “Attribute bearbeiten”.  
