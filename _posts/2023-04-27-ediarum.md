...
* Die ediarum-App öffnet sich nun in einem weiteren Fenster im Browser, wo wir im Menü zu Verwaltung > Projekte gehen und dort im Feld “Neues Projekt” einen Projektnamen für unsere Edition anlegen und abschließend auf “Anlegen” klicken. 
...
* Abschließend richten wir uns noch im Oxygen XML Author ein Projekt ein. Dafür gehen wir in Oxygen auf Projekt > Neues Projekt und wählen dort den Ordner unseres projektspezifischen Frameworks aus. 
...
<table class="table">
  ...
  <tr>
   <td>Stefan Dumont (ediarum.Base, XML Author)
   </td>
   <td><a href="mailto:dumont@bbaw.de">dumont@bbaw.de</a>
   </td>
  </tr>
  <tr>
   <td>Martin Fechner (ediarum Web + eXist)
   </td>
